		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#mcconsumomateriales-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mcconsumomateriales-display": {
								"semanticObject": "mcconsumomateriales",
								"action": "display",
								"description": "Consumo de materiales serializados y no serializados ",
								"title": "Consumo Materiales",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mc.consumomateriales",
									"url": sap.ui.require.toUrl("mc/consumomateriales")
								}
							}
						}
					}
